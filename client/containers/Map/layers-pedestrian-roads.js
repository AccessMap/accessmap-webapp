...
const PedestrianRoads = (props) => {
  ...
  return (
    <React.Fragment>
      <Layer
        id='pedestrian-road-click'
        type='line'
        sourceId='paths'
        sourceLayer='pedestrian_roads'
        paint={{
          'line-width': {
      ...
      />
      <Layer
        id='pedestrian-roads-inaccessible'
        type='line'
        sourceId='paths'
        sourceLayer='pedestrian_roads'
        filter={[
      ...
      />
      <Layer
        id='pedestrian-road-downhill-arrow'
        type='symbol'
        sourceId='paths'
        sourceLayer='pedestrian_roads'
        minZoom={16}
